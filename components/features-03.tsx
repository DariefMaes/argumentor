        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20 border-b border-slate-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Uncover the Story Behind Every Argument
            </h2>
            <p className="text-lg text-slate-400">
              Dive into a world where every discussion is backed by credible
              research and nuanced insights, far beyond the surface-level
              chatter.
            </p>
          </div>
                ...
                <HighlighterItem>
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div
                      ...
                      aria-hidden="true"
                    >
                      <div className="absolute inset-0 translate-z-0 bg-green/50 rounded-full blur-[120px]" />
                    </div>
                    <Image
                      src={FeatureImg04}
                      width={773}
                      height={297}
                      className="p-3 rounded-md overflow-hidden"
                      alt="Feature 04"
                    />
                  </div>
                </HighlighterItem>
