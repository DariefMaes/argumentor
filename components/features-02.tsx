...
import FeatureImg02 from "@/public/images/speed.png";
import FeatureImg03 from "@/public/images/aplus.png";
        ...
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              ArguMentor isn’t just about finding sources; it’s about mastering
              the art of argumentation. With our intuitive interface and
              cutting-edge AI, you’re not just staying ahead; you’re redefining
          ...
          <div className="relative pb-12 md:pb-20">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="434" height="427">
                <defs>
                  <linearGradient
                    ...
                    y2="100%"
                  >
                    <stop offset="0%" stopColor="#03C988" />
                    <stop offset="100%" stopColor="#03C988" stopOpacity="0" />
                  </linearGradient>
                </defs>
                <path
                  fill="url(#bs2-a)"
            ...
            <Highlighter className="grid md:grid-cols-12 gap-6 group">
              ...
              {/* <div
                        ...
                        aria-hidden="true"
                      >
                        <div className="absolute inset-0 translate-z-0 bg-green rounded-full blur-[120px] opacity-70" />
                        <div className="absolute w-1/4 h-1/4 translate-z-0 bg-green rounded-full blur-[40px]" />
                      </div> */}
              {/* Text */}
              {/* <div className="md:max-w-[480px] text-center shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        <div className="mb-5">
                          <div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Ace your research with unrivaled speed. Our
                            platform's swift response times mean you're always a
                            step ahead.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Stay focused on crafting compelling arguments and
                            let us handle the data delivery for your scholarly
                            pursuits.
                          </p>
                        </div>
                      </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Stable Platform</h4>
              </div>
              <p className="text-sm text-slate-400">
                Depend on uninterrupted performance for consistent research
                progress.
              </p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Dynamic Support</h4>
              </div>
              <p className="text-sm text-slate-400">
                Adapt and thrive with a platform that grows to meet your
                academic needs.
              </p>
            </div>
            {/* Feature */}
            <div>
              ...
              <p className="text-sm text-slate-400">
                Navigate a seamless interface tailored for an intuitive research
                experience.
              </p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Instant Access</h4>
              </div>
              <p className="text-sm text-slate-400">
                Accelerate your studies with instant, AI-driven search results.
              </p>
            </div>
            {/* Feature */}
            <div>
              ...
              <p className="text-sm text-slate-400">
                Keep your research neat and manageable with a streamlined
                dashboard.
              </p>
            </div>
            {/* Feature */}
            <div>
              ...
              <p className="text-sm text-slate-400">
                Your research privacy is safeguarded with top-tier security
                measures.
              </p>
            </div>
          </div>
